...
enum Colors {
    ...
    static let lightGreen = UIColor(red: 31/255, green: 163/255, blue: 66/255, alpha: 0.05)
    static let lightRed = UIColor(red: 217/255, green: 58/255, blue: 74/255, alpha: 0.05)
