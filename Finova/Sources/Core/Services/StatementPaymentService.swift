...
final class StatementPaymentService {
    ...
    func pay(
        ...
        finishMutation(paymentId: paymentId, statementId: stmtId, paymentDate: paymentDate)
    ...
    private func finishMutation(paymentId: Int, statementId: Int, paymentDate: Date) {
        TransactionRepository.invalidateCache()
        ...
        transactionRepo.reconcileNotification(transactionId: paymentId)
