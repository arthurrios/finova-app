...
NOT included in current balance:
    - Unpaid credit card statements (shown separately)
...
│                                                                 │
│  ┌───────────────────────────────────────────────────────────┐  │
│  │  💳 Credit Card Bills Coming Up                           │  │
│  │                                                           │  │
│  │  Nubank •••• 1234          Due Feb 22     R$ 1.250,00    │  │
│  │  Itaú •••• 5678            Due Feb 25       R$ 890,00    │  │
│  │                            ────────────                   │  │
│  │                            Total:         R$ 2.140,00    │  │
│  └───────────────────────────────────────────────────────────┘  │
│                                                                 │
│  After paying cards: R$ 1.310,00                               │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
